...
def co2_gdp_plot():
    ...
    df_climate = df_climate.replace({np.nan: 0})
    ...
    df_co2 = df_co2[['Country code', 'CO2-SUM']]
    ...
    df_gdp = df_gdp[['Country code', 'GDP-SUM']]
    ...
    #print(df.head(5))
    co2 = df.loc['CHN']['CO2-SUM']
    gdp = df.loc['CHN']['GDP-SUM']
